...
[![Tests](https://img.shields.io/badge/Tests-Node_12%2F12_%7C_Python_11%2F11_PASS-brightgreen)](tests/)
...
- **T02 请假申请智能体**：收集结构化表单四字段，通过规则引擎计算审批路径并回显预览，经用户明确确认后直接调用后端 API 创建草稿并提交；Main Agent 本身不挂载写工具，未确认或取消时 0 次调用写 API；
